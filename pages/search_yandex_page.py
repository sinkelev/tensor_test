...
class SearchPage(Region):
    ...
    site_cslst =    CustomList(     By.XPATH,        '//*[@class="serp-item"]//h2//a', 'Ссылки на сайт')
    ...
    def first_five_links_in_search_result(self, search_link):
        ...
        for link in self.site_cslst:
            link = link.get_attribute('href')
            assert_that(search_link, is_in(link), f'Ссылка {link} не совпадает с {search_link}')
